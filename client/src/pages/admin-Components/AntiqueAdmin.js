...
class AntiqueAdmin extends Component {
        ...
        return (
            <div className="container-admin">
                <div className='new-photo-admin'>
                    <h3>New Photo Upload for <strong>Antique</strong></h3>
                    <hr></hr>
                    <p>Make sure to include "Antique" tag in "advance options" when upload new photo</p>
