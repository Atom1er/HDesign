...
class DecorAdmin extends Component {
        ...
        return (
            <div className="container-admin">
                <div className='new-photo-admin'>
                    <h3>New Photo Upload for <strong>Decor</strong></h3>
                    <hr></hr>
                    <p>Make sure to include "Decor" tag in "advance options" when upload new photo</p>
